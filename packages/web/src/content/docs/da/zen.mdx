...
- Space Bunny er en stealth-model, som er gratis på OpenCode i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
- Space Bunny: I den gratis periode kan indsamlede data blive brugt til at forbedre modellen.
