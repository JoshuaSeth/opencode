...
- Space Bunny Free est un modèle stealth gratuit sur OpenCode pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
...
- Space Bunny Free : Pendant sa période gratuite, les données collectées peuvent être utilisées pour améliorer le modèle.
