...
- Space Bunny è un modello stealth che è gratuito su OpenCode per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
- Space Bunny: durante il periodo gratuito, i dati raccolti possono essere usati per migliorare il modello.
