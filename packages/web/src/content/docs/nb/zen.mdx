...
- Space Bunny er en stealth-modell som er gratis på OpenCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
- Space Bunny: I gratisperioden kan innsamlede data brukes til å forbedre modellen.
