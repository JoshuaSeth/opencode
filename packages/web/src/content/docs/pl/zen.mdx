...
- Space Bunny to stealth model, który jest darmowy w OpenCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
- Space Bunny: W czasie darmowego okresu zebrane dane mogą być wykorzystywane do ulepszania modelu.
