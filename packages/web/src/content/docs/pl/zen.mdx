...
- Space Bunny Free to stealth model, który jest darmowy w OpenCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
- Space Bunny Free: W czasie darmowego okresu zebrane dane mogą być wykorzystywane do ulepszania modelu.
