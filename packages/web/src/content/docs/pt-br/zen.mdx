...
- Space Bunny é um modelo stealth que está gratuito no OpenCode por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
...
- Space Bunny: Durante seu período gratuito, os dados coletados podem ser usados para melhorar o modelo.
