...
- Space Bunny Free é um modelo stealth que está gratuito no OpenCode por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
...
- Space Bunny Free: Durante seu período gratuito, os dados coletados podem ser usados para melhorar o modelo.
