...
- Space Bunny Free, sınırlı bir süre için OpenCode'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
- Space Bunny Free: Ücretsiz döneminde toplanan veriler modeli iyileştirmek için kullanılabilir.
