...
- Space Bunny, sınırlı bir süre için OpenCode'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
- Space Bunny: Ücretsiz döneminde toplanan veriler modeli iyileştirmek için kullanılabilir.
