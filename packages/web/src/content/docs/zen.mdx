...
- Space Bunny is a stealth model that's free on OpenCode for a limited time. The team is using this time to collect feedback and improve the model.
...
- Space Bunny: During its free period, collected data may be used to improve the model.
